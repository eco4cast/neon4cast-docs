...
**When**: Daily forecasts for at least 30-days in the future are accepted at any time. Forecast submissions are accepted daily. The only requirement is that submissions are predictions of the future at the time the forecast is submitted.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/P8OwhCF4AdI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
...
Functions for downloading and working with the meteorology forecasts can be be found @sec-met
...
Code for the persistence null model can be found [here](https://github.com/eco4cast/neon4cast-baselines/blob/main/phenology_persistance.R){target="\"_blank"}

Code for the climatology null model can be found [here](https://github.com/eco4cast/neon4cast-baselines/blob/main/phenology_climatology.R){target="_blank"} \## FAQ
