...
Forecasts for a minimum of 30 days can be submitted daily by 12:59 pm UTC any day. New forecasts can be submitted daily as new weather forecasts and observations (e.g., PhenoCam) become available (see @sec-cron). The key is that submissions are predictions of the future.
...
The following have been involved in the design of the phenology challenge
