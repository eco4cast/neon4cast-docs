...
**When:** Forecasts for 52 weeks into the future using a weekly time-step are accepted at any time. Forecasts that start in the current week are due by Sunday at 12:59 pm (UTC).
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/7196wcarMXQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
...
Code for the mean null model can be found [here](https://github.com/eco4cast/neon4cast-baselines/blob/main/beetles_mean.R){target="_blank"}
