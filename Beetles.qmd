...
The code use to process the raw data to the evaluation data can be found here: https://github.com/eco4cast/NEON-community-forecast/blob/master/02_targets.R
...
The required time unit: `date` for the Monday of the corresponding isoweek
