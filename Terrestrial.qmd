...
Code for the 30 minute climatology null model can be found [here](https://github.com/eco4cast/neon4cast-baselines/blob/main/terrestrial_30min_climatology.R){target="_blank"}
