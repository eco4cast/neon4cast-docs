...
The null model will be automatically generated each week, and is the historical mean for each week at each site. For weeks that don't have observations, the forecast is a linear interpolation between the preceding and following weeks.

Code for the daily climatology null model can be found [here](https://github.com/eco4cast/neon4cast-baselines/blob/main/ticks_climatology.R){target="_blank"}
