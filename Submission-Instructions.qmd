...
```{r}
readr::read_csv("https://data.ecoforecast.org/neon4cast-forecasts/raw/aquatics/aquatics-2022-09-23-climatology.csv.gz", show_col_types = FALSE)
```
Here is an example of a forecast that uses ensembles: 

```{r}
readr::read_csv("https://data.ecoforecast.org/neon4cast-forecasts/raw/aquatics/aquatics-2022-09-23-persistenceRW.csv.gz", show_col_types = FALSE)
```
