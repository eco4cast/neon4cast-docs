...
Where `year`, `month`, and `day` are the year, month, and day of the first forecast (horizon = 1).  For example, if a forecast starts today and tomorrow is the first forecasted day, horizon = 1 would be tomorrow, and used in the file name.
...
-   `start_time`: The start of the forecast; this should be 0 times steps in the future (horizon = 0)
...
-   `start_time`: The start of the forecast; this should be 0 times steps in the future
-   `site_id`: NEON code for site
